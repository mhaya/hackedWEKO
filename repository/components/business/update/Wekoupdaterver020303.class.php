...
/**
 * Common classes of WEKO update process to ver.2.3.3
 ...
 */
require_once WEBAPP_DIR. '/modules/repository/components/business/update/Wekoupdaterver020302.class.php';
 ...
 * @access public
 */
class Repository_Components_Business_Update_Wekoupdaterver020303 extends Repository_Components_Business_Update_Wekoupdaterver020302
{
    /**
     ...
     * @var string
     */
    const UPDATER_VERSION = "2.3.3";
    
    /**
     * The update process from the ver.2.3.2 to ver.2.3.3: overridden by each inherited class, there is need to write about the same content
     * ver.2.3.2からver.2.3.3へのアップデート処理：各継承クラスでオーバーライドし、ほぼ同じ内容を記述する必要あり
     *
    ...
    protected function update($nowVersion){
        ...
        // ver.2.3.3へのアップデート処理(各継承クラスで実装したとき、ここだけそのバージョンのアップデート処理に合わせて変更する必要あり)
        $this->updateTo233();
    ...
    /**
     * The update process to WEKO ver.2.3.3
     * WEKO ver.2.3.3へのアップデート処理
     */
    protected function updateTo233(){
        // 変更なし
    }
}
?>